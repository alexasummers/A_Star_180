...
//-------------------------------------------------------------
	...
	void FindPath(Vector3 startPos, Vector3 targetPos) { //generates the path between point A and point B
		...
		//we can search for the node with the lowest fCost and easy to add and take away from AND search through
		...
		//rather than a list for this one because it is easy to add to and take away from, but since we don't need to search, we can use a hashset12 c 
